...
class DataProcessor:
    ...
    def process(self, dataset):
        ...
        # the reason of comment out _add_eos_examples
        # UserWarning: This sequence already has </s>. 
        # In future versions this behavior may lead to duplicated eos tokens being added.
...
def main():
    ...
    train_dataset = Dataset.from_pandas(pd.DataFrame(read_data("../dataset/multitask/ext_gen/train_gen_ext_10000.json")))
    valid_dataset = Dataset.from_pandas(pd.DataFrame(read_data("../dataset/multitask/ext_gen/valid_gen_ext_1509.json")))
    ...
    #     train_file_name = "train_data_gen_mt5.pt"
    #     train_path = os.path.join("data", train_file_name)
    if data_args.train_file_name is None:
        train_file_name = "train_data_ext_gen_mt5.pt"
        train_path = os.path.join("data", train_file_name)

        valid_file_name = "valid_data_ext_gen_mt5.pt"
    ...
    tokenizer_path = "mt5_qa_tokenizer"
