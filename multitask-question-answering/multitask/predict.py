...
class SumPipeline:
    ...
    def __call__(self, inputs: str):
        ...
        sents, answers = self._extract_answer(inputs)
...
class MultiTaskPipeline(QGPipeline):
    ...
    def __call__(self, inputs: Union[Dict, str]):
        if type(inputs) is str:
            ...
            # do qa
            return self._generate_answer(inputs["question"], inputs["context"])
    ...
    if tokenizer is None:
        if isinstance(model, str):
            ...
            raise Exception(
                ...
                "Please provided a Pretrained Tokenizer class or a path/identifier to a pretrained tokenizer."
            )
